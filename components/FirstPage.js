...
import LogementType from './LogementType';
import ConstructionDate from './ConstructionDate';
import WhatWork from './WhatWork';
import Surface from './Surface';
import Where from './Where';
import StepOfYourProject from './StepOfYourProject';
  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.tree}>
        ...
        {currentComponent}
        {/*Changement de composant*/ }
        <button className={styles.continue} onClick={() => keepGoing()} >{keepgoingBtn}</button>

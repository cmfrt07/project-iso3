...
import { setComblesSurface } from '../../reducers/plan';
...
function ComblesSurface(){
  ...
  const handleContinue = () => {
    if(cpt.length < 1){
      ...
      setVerifChamp("")
      dispatch(setComblesSurface(cpt));
      dispatch(setNewCpt())
    ...
    <main className={styles.main}>
      ...
      <div className={styles.tree}>
        ...
        <p>retour</p>
          ...
          <h2>Quelle est la surface approximative de combles à isoler ?</h2>
            <p>Cela suffit pour estimer vos aides : votre artisan mesurera vos murs lors de sa visite.</p>

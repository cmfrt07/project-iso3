...
import { setMursSurface } from '../../reducers/plan';
    ...
    <main className={styles.main}>
      ...
      <div className={styles.tree}>
        ...
        <div className={styles.mainDiv}>
          <h2>Quelle est la surface approximative de murs à isoler ?</h2>

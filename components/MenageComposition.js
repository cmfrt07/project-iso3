...
import styles from '../styles/MenageComposition.module.css';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faArrowLeft } from '@fortawesome/free-solid-svg-icons'
import { useRouter } from 'next/router'
import {useSelector, useDispatch} from 'react-redux';
import Image from 'next/image';
import { setMenageComposition } from '../reducers/plan';
import { clearCodePostal } from '../reducers/plan';
...
function MenageComposition(){
  ...
  const handleContinue = () => {
      dispatch(setMenageComposition(cpt));
      router.push("/menage-revenus")
  };

  const handleRetour = () => {
    dispatch(clearCodePostal())
    ...
    <main className={styles.main}>
      ...
      <div className={styles.tree}>
        ...
        <p>retour</p>
          ...
          <h2>Combien de personnes composent votre foyer, vous compris ?</h2>
          <p>Le montant de vos aides peut varier en fonction de la taille de votre ménage.</p>
...
export default MenageComposition;